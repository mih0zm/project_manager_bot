...
/projects - используй для просмотра своих добавленных проектов💻📑
/skills - используй для добавления навыка в выбранный проект🆙
/delete - используй для удаления проекта🗑️
/update_projects - используй если хочешь что-то изменить в проекте✍️💻
